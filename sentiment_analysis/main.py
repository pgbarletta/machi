...
#         print('theta for', algo_name, 'is',
#               ', '.join(map(str, list(thetas[0]))))
...
# theta_va, theta_0_va = p1.pegasos(val_bow_features, val_labels, 25, 0.01)
# rtdo_test_labels_va = p1.classify(test_bow_features, theta_va, theta_0_va)
# acc_va = p1.accuracy(rtdo_test_labels_va, test_labels)
# print("acc_tr:  ", acc_va)

# theta_te, theta_0_te = p1.pegasos(test_bow_features, test_labels, 25, 0.01)
# rtdo_test_labels_te = p1.classify(test_bow_features, theta_te, theta_0_te)
# acc_te = p1.accuracy(rtdo_test_labels_te, test_labels)
# print("acc_va:  ", acc_te)

theta_tr, theta_0_tr = p1.pegasos(train_bow_features, train_labels, 25, 0.01)
rtdo_test_labels_tr = p1.classify(test_bow_features, theta_tr, theta_0_tr)
acc_tr = p1.accuracy(rtdo_test_labels_tr, test_labels)
print("acc_te:  ", acc_tr)
